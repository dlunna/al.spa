...
def contact(request):
    ...
    # contact_form = contactform se usa para instanciar el formulario
    # y poder llamarlo en el template
...
def emailcontact(request):
    ...
    return render(request, "contact/contact-full.html", {'form':contact_form})
